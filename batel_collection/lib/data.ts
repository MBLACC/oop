...
export interface Product {
    ...
    description: string
    price: number
    category: "clothes" | "shoes" | "accessories" | "bags" | "perfume" | "in-store"
    subcategory?: string
    image: string
    images: string[]
    featured?: boolean
...
const products: Product[] = [
    ...
    ...Array.from({ length: 1 }, (_, i) => ({
        ...
        description: "Exquisite scent for special moments.",
        price: 38000,
        category: "accessories" as const,
        subcategory: "perfume",
        image: `/images/WOMEN/Accessories/perfumes/perfume2/1.png`,
        images: [`/images/WOMEN/Accessories/perfumes/perfume2/1.png`, `/images/WOMEN/Accessories/perfumes/perfume2/2.png`],
    })),

    // --- Accessories: Lipsticks ---
    ...Array.from({ length: 19 }, (_, i) => ({
        id: `acc_lip_vs_${i + 1}`,
        name: `Victoria Secret Fruity Lipstick ${i + 1}`,
        description: "Vibrant and moisturizing lip color.",
        price: 20000,
        category: "accessories" as const,
        subcategory: "lipstick",
        image: `/images/WOMEN/Accessories/LipStick/Victor Secret fruity/${i + 1}.png`,
        images: [`/images/WOMEN/Accessories/LipStick/Victor Secret fruity/${i + 1}.png`],
    })),
    {
        id: "acc_lip_mac_1",
        name: "MAC Matte Lipstick",
        description: "Classic MAC matte finish lipstick.",
        price: 48000,
        category: "accessories",
        subcategory: "lipstick",
        image: "/images/WOMEN/Accessories/LipStick/MAC LIPSTICK/1.jfif",
        images: ["/images/WOMEN/Accessories/LipStick/MAC LIPSTICK/1.jfif", "/images/WOMEN/Accessories/LipStick/MAC LIPSTICK/Mac Strip Down Lipstick Collection.jfif"],
    },
    ...
    // --- Accessories: Mascara ---
    {
        ...
        description: "Extra volume for stunning lashes.",
        price: 48000,
        category: "accessories",
        subcategory: "mascara",
        image: "/images/WOMEN/Accessories/Mascara/Mascara1/mascar1.png",
        images: ["/images/WOMEN/Accessories/Mascara/Mascara1/mascar1.png", "/images/WOMEN/Accessories/Mascara/Mascara1/2.png"],
    },
    ...
    ...Array.from({ length: 19 }, (_, i) => ({
        id: `s_smallheel_${i + 1}`,
        name: `Shoe on Heels ${i + 1}`,
        description: "Elegant shoe on heels for stable comfort.",
        price: 35000,
        category: "shoes" as const,
        subcategory: "on heels",
    ...
    // In Store: Fascinator Hats
    ...Array.from({ length: 9 }, (_, i) => ({
        id: `is_hat_${i + 1}`,
        name: `In-Store Fascinator Hat ${i + 1}`,
        description: "Elegant headwear available for immediate purchase in-store.",
        price: 15000,
        category: "in-store" as const,
        subcategory: "hat",
        image: `/images/IN_STORE_PRODUCT/Fascinator_hat/${i + 1}.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/Fascinator_hat/${i + 1}.jpeg`],
    })),

    // In Store: Beauty (Lipstick)
    ...Array.from({ length: 19 }, (_, i) => ({
        id: `is_lip_vs_${i + 1}`,
        name: `In-Store VS Fruity Lipstick ${i + 1}`,
        description: "Premium lip color available in-store.",
        price: 20000,
        category: "in-store" as const,
        subcategory: "lipstick",
        image: `/images/IN_STORE_PRODUCT/LipStick/Victor Secret fruity/${i + 1}.png`,
        images: [`/images/IN_STORE_PRODUCT/LipStick/Victor Secret fruity/${i + 1}.png`],
    })),
    {
        id: "is_lip_mac_1",
        name: "In-Store MAC Matte Lipstick",
        description: "Classic MAC matte finish available in-store.",
        price: 48000,
        category: "in-store",
        subcategory: "lipstick",
        image: "/images/IN_STORE_PRODUCT/LipStick/MAC LIPSTICK/1.jfif",
        images: ["/images/IN_STORE_PRODUCT/LipStick/MAC LIPSTICK/1.jfif", "/images/IN_STORE_PRODUCT/LipStick/MAC LIPSTICK/Mac Strip Down Lipstick Collection.jfif"],
    },

    // In Store: Beauty (Mascara, Hair Wax, Heel Pads)
    {
        id: "is_mascara_1",
        name: "In-Store Volume Mascara",
        description: "Professional mascara available in-store.",
        price: 48000,
        category: "in-store",
        subcategory: "mascara",
        image: "/images/IN_STORE_PRODUCT/Mascara/Mascara1/mascar1.png",
        images: ["/images/IN_STORE_PRODUCT/Mascara/Mascara1/mascar1.png", "/images/IN_STORE_PRODUCT/Mascara/Mascara1/2.png"],
    },
    ...Array.from({ length: 2 }, (_, i) => ({
        id: `is_wax_${i + 1}`,
        name: `In-Store Hair Wax ${i + 1}`,
        description: "Styling wax available in-store.",
        price: 40000,
        category: "in-store" as const,
        subcategory: "hair wax",
        image: `/images/IN_STORE_PRODUCT/Hair wax/${i + 1}.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/Hair wax/${i + 1}.jpeg`],
    })),
    ...Array.from({ length: 3 }, (_, i) => ({
        id: `is_heelpad_${i + 1}`,
        name: `In-Store Heel Pad ${i + 1}`,
        description: "Comfort pads available in-store.",
        price: 9000,
        category: "in-store" as const,
        subcategory: "heel pad",
        image: `/images/IN_STORE_PRODUCT/heel_pads/${i + 1}.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/heel_pads/${i + 1}.jpeg`],
    })),

    // In Store: Perfumes
    {
        id: "is_perfume_1",
        name: "In-Store Signature Perfume",
        description: "Designer fragrance available in-store.",
        price: 38000,
        category: "in-store",
        subcategory: "perfume",
        image: "/images/IN_STORE_PRODUCT/perfumes/perfume1/1.jpeg",
        images: ["/images/IN_STORE_PRODUCT/perfumes/perfume1/1.jpeg"],
    },
    {
        id: "is_perfume_2",
        name: "In-Store Luxury Scent",
        description: "Premium perfume available in-store.",
        price: 38000,
        category: "in-store",
        subcategory: "perfume",
        image: "/images/IN_STORE_PRODUCT/perfumes/perfume2/1.png",
        images: ["/images/IN_STORE_PRODUCT/perfumes/perfume2/1.png", "/images/IN_STORE_PRODUCT/perfumes/perfume2/2.png"],
    },

    // In Store: Bags and Balenciaga Items
    ...Array.from({ length: 1 }, (_, i) => ({
        id: `is_bag1_${i + 1}`,
        name: `In-Store Premium Bag ${i + 1}`,
        description: "Stylish bag available in-store.",
        price: 45000,
        category: "in-store" as const,
        subcategory: "bags",
        image: `/images/IN_STORE_PRODUCT/bag1/1.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/bag1/1.jpeg`, `/images/IN_STORE_PRODUCT/bag1/2.jpeg`],
    })),
    ...[2, 3, 5, 9, 14].map(num => ({
        id: `is_balen_${num}`,
        name: `In-Store Designer Item ${num}`,
        description: "Exclusive designer item available in-store.",
        price: 26000,
        category: "in-store" as const,
        subcategory: "balen",
        image: `/images/IN_STORE_PRODUCT/balen${num}/1.jpeg`,
        images: Array.from({ length: (num === 14 ? 3 : 2) }, (_, i) => `/images/IN_STORE_PRODUCT/balen${num}/${i + 1}.jpeg`),
    })),

    // In Store: Shoes (Close Shoes)
    ...[1, 6, 11].map(num => ({
        id: `is_close_${num}`,
        name: `In-Store Close Shoe ${num}`,
        description: "Classic closed shoe available in-store.",
        price: 20000,
        category: "in-store" as const,
        subcategory: "close shoes",
        image: `/images/IN_STORE_PRODUCT/close${num}/1.jpeg`,
        images: Array.from({ length: (num === 6 ? 1 : 2) }, (_, i) => `/images/IN_STORE_PRODUCT/close${num}/${i + 1}.jpeg`),
        sizes: ["37", "38", "39", "40"],
    })),

    // In Store: Shoes (High Heels)
    ...[2, 8, 11, 13, 14].map((num, i) => ({
        id: `is_highheel_${num}`,
        name: `In-Store Shoe on Heels ${num}`,
        description: "Elegant shoe on heels available in-store.",
        price: 40000 + (i * 2000), // Ranging from 40k to 48k
        category: "in-store" as const,
        subcategory: "on heels",
        image: `/images/IN_STORE_PRODUCT/high_heel${num}/1.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/high_heel${num}/1.jpeg`, `/images/IN_STORE_PRODUCT/high_heel${num}/2.jpeg`],
        sizes: ["36", "37", "38", "39"],
    })),

    // In Store: Shoes (Open Shoes)
    ...[1, 3, 6].map(num => ({
        id: `is_open_${num}`,
        name: `In-Store Open Shoe ${num}`,
        description: "Stylish open shoe available in-store.",
        price: 25000,
        category: "in-store" as const,
        subcategory: "open shoes",
        image: `/images/IN_STORE_PRODUCT/open${num}/1.jpeg`,
        images: Array.from({ length: (num === 3 ? 1 : 2) }, (_, i) => `/images/IN_STORE_PRODUCT/open${num}/${i + 1}.jpeg`),
        sizes: ["37", "38", "39"],
    })),

    // In Store: Shoes (Sandals)
    ...[1, 4, 8].map(num => ({
        id: `is_sandal_${num}`,
        name: `In-Store Sandal ${num}`,
        description: "Casual sandal available in-store.",
        price: 20000,
        category: "in-store" as const,
        subcategory: "sandal",
        image: `/images/IN_STORE_PRODUCT/sandal${num}/1.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/sandal${num}/1.jpeg`, `/images/IN_STORE_PRODUCT/sandal${num}/2.jpeg`],
        sizes: ["36", "37", "38", "39"],
    })),

    // In Store: Shoes (Small Heels)
    ...[1, 4, 8, 12, 17].map(num => ({
        id: `is_smallheel_${num}`,
        name: `In-Store Shoe on Heels ${num}`,
        description: "Comfortable shoe on heels available in-store.",
        price: 35000,
        category: "in-store" as const,
        subcategory: "on heels",
        image: `/images/IN_STORE_PRODUCT/small_heel${num}/1.jpeg`,
        images: [`/images/IN_STORE_PRODUCT/small_heel${num}/1.jpeg`, `/images/IN_STORE_PRODUCT/small_heel${num}/2.jpeg`],
        sizes: ["37", "38", "39", "40"],
    })),
]
...
export const categories: Category[] = [
    ...
    },
    {
        id: "in-store",
        name: "In Store",
        description: "Items currently available in our physical store.",
        image: "/images/IN_STORE_PRODUCT/high_heel11/1.jpeg",
    },
]
